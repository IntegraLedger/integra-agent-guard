...
// against the built workspace. Two sources: the root README, and every package README.
//
...
if (mdFiles.length !== expectedDocs) {
  console.error(
    `check:docs — BLIND GATE: walked ${mdFiles.length} doc(s), an independent enumeration expects ` +
      `${expectedDocs} (root README + every package README). The two must agree; "clean" from a walker ` +
